...
<body>
    ...
    <main>
        ...
        <form action="add-places.php" method="post"
            onsubmit="return confirm('Êtes-vous sûr de vouloir ajouter ce place?')">
            <label for="idLieu">Id du Lieu :</label>
            <input type="text" name="idLieu" id="idLieu" required>
        ...
        <p class="paragraph-link">
            <a class="link-home" href="manage-places.php">Retour à la gestion des places</a>
        </p>
    </main>
    <footer>
        <figure>
