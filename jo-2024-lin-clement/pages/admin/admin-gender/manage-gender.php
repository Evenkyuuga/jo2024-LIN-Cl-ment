...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT * FROM GENRE ORDER BY id_genre, nom_genre";
            ...
            if ($statement->rowCount() > 0) {
                ...
                echo "<th class='couleur'>nom_genre</td>";
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td class='color'>" . htmlspecialchars($row['nom_genre']) . "</td>"; // Utilisation de la classe 'color' pour changer la couleur
                    echo "<td><button onclick='openModifyPlacesForm(\"{$row['id_genre']}, \"{$row['nom_genre']}\")'>Modifier</button></td>";
                    echo "<td><button onclick='deletePlacesConfirmation(\"{$row['id_genre']}, \"{$row['nom_genre']}\")'>Supprimer</button></td>";
                    echo "</tr>";
                }
