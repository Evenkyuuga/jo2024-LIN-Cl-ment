...
<body>
    ...
    <main>
        ...
        <form action="add-events.php" method="post"
            ...
            <label for="idEpreuve">Id du Epreuve :</label>
            <input type="text" name="idEpreuve" id="idEpreuve" required>

            <label for="nomEpreuve">Nom du Epreuve :</label>
            ...
            <label for="heureEpreuve">Heure du Epreuve :</label>
            <input type="text" name="heureEpreuve" id="heureEpreuve" required>

            <label for="LieuEpreuve">Lieu du Epreuve :</label>
            <input type="text" name="lieuEpreuve" id="lieuEpreuve" required>

            <label for="SportEpreuve">Sport du Epreuve :</label>
            <input type="text" name="sportEpreuve" id="sportEpreuve" required>
