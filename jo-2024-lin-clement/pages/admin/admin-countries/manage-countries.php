...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT * FROM PAYS ORDER BY id_pays, nom_pays";
            ...
            if ($statement->rowCount() > 0) {
                ...
                echo "<th class='couleur'>nom_pays</td>";
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td class='color'>" . htmlspecialchars($row['nom_pays']) . "</td>"; // Utilisation de la classe 'color' pour changer la couleur
                    echo "<td><button onclick='openModifyPlacesForm(\"{$row['id_pays']}\", \"{$row['nom_pays']}\")'>Modifier</button></td>";
                    echo "<td><button onclick='deletePlacesConfirmation(\"{$row['id_pays']}\", \"{$row['nom_pays']}\")'>Supprimer</button></td>";
                    echo "</tr>";
                }
